...
const Footer = () => {
  ...
  return (
    <footer className="bg-lima-50 text-gray-800">
      {/* Main Footer Content */}
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 border-t border-gray-200">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-12">
          {/* Column 1 - About Kitchivo */}
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-700 text-xs sm:text-sm leading-relaxed mb-4 sm:mb-6">
              Transform your kitchen with premium quality essentials. We curate
              the finest cookware, utensils, and home products to make cooking a
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-2 sm:gap-3">
                <svg
                  className="w-4 h-4 sm:w-5 sm:h-5 text-lima-600 mt-0.5 shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
      ...
      {/* Bottom Footer */}
      <div className="border-t border-lima-200">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
            {/* Copyright */}
            <p className="text-gray-700 text-xs sm:text-sm text-center md:text-left font-medium">
              © {new Date().getFullYear()} Kitchivo. All Rights Reserved.
            </p>
